...
alloc1sf_double_complex   allocate a 1-d array of complexs
realloc1sf_double_complex re-allocate a 1-d array of complexs
free1sf_double_complex    free a 1-d array of complexs
alloc2sf_double_complex   allocate a 2-d array of complexs 
free2sf_double_complex    free a 2-d array of complexs
alloc3sf_double_complex   allocate a 3-d array of complexs  
free3sf_double_complex    free a 3-d array of complexs
...
complex *alloc1sf_double_complex (int n1);
complex *realloc1sf_double_complex (sf_double_complex *v, int n1);
void free1sf_double_complex (sf_double_complex *p);
complex **alloc2sf_double_complex (int n1, int n2);
void free2sf_double_complex (sf_double_complex **p);
complex ***alloc3sf_double_complex (int n1, int n2, int n3);
...
/* allocate a 5-d array of ints, added by Zhaobo Meng, 1997 */
unsigned short *****alloc5ushort(int n1, int n2, int n3,
        int n4, int n5)
{
...
{
	return (sf_complex*)realloc1(v,n1,sizeof(sf_complex));
}
...
{
	return (sf_double_complex*)alloc1(n1,sizeof(sf_double_complex));
}

/* re-allocate a 1-d array of complexs */
sf_double_complex *realloc1sf_double_complex(sf_double_complex *v, int n1)
{
	return (sf_double_complex*)realloc1(v,n1,sizeof(sf_double_complex));
}
...
{
	return (sf_double_complex**)alloc2(n1,n2,sizeof(sf_double_complex));
}
...
{
	return (sf_double_complex***)alloc3(n1,n2,n3,sizeof(sf_double_complex));
}
