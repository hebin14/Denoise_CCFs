...
sfile     = os.path.join(rootpath,'STACK/4A.214/4A.214_4A.417.h5')    # ASDF file containing stacked data
outdir    = os.path.join(rootpath,'pics')                     # dir where to output dispersive image and extracted dispersion
