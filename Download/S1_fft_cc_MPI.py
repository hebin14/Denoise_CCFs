...
local_data_path = os.path.join(rootpath,'*.h5')                           # absolute dir where SAC files are stored: this para is VERY IMPORTANT and has to be RIGHT if input_fmt is not h5 for asdf!!!
...
maxlag         = 80                                                        # lags of cross-correlation to save (sec)
